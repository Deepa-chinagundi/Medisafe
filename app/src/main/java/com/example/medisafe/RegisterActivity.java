    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.length()==8 || email.length()==0 || password.length()==0 || confirm.length()==0){
                    ...
                    if (password.compareTo(confirm) == 0) {
                        if (isValid(password)) {
                            ...
                            Toast.makeText(getApplicationContext(), "Password must contain at least & characters, having letter, digit and special chracter", Toast.LENGTH_SHORT).show();
                        }
                    } else {
