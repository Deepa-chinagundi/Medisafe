...
public class DoctorDetailsActivity extends AppCompatActivity {
    private String[][] doctor_details1 =
    {
        ...
        {"Doctor Name: Swapnil Kale", "Hospital Address: Pune", "Exp: Byrs", "Mobile No:8898989898", "308"},
        {"Doctor Name: Deepak Deshmukh", "Hospital Address: Chinchwad", "Exp: 6yrs", "Mobile No: 9898000000", "508"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.textViewLTTitle2);
